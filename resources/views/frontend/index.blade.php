                ...
                <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                    <div class="cs_top_services_box">
                        <div class="cs_top_services_icon">
                            <div class="cs_top_services_icon">
                                <p>
                                    <img src="{{ asset('images/backend') }}/{{ $item->icon }}"
                                    alt="{{$item->name}}" width="60" height="40">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 order-lg-1 order-md-1 order-sm-2 order-2">
                    <div class="cs_about_img wow fadeInUp" data-wow-delay="0.3s">
                        <img src="{{ asset('images/backend') }}/{{ $aboutus->image }}" class="img-fluid" alt="images">
                        {{-- <img src="{{asset('frontend')}}/images/index/about_img1.png" > --}}
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 order-lg-1 order-md-2 order-sm-1 order-1">
                    <div class="cs_about_content" data-wow-duration="0.8s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInRight;">
                        <h5>{{ $aboutus->menuTitle }}</h5>
                        <h1>{{ $aboutus->shortDesc }}</h1>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="cs_people_choose_slider_img">
                                        <img src="{{ asset('images/backend') }}/{{ $us->image }}" class="img-fluid" alt="images">
                                    </div>
                                </div>
                                {{-- <div class="swiper-slide">
                                    <div class="cs_people_choose_slider_img">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="cs_our_service_box wow zoomIn" data-wow-delay="0.1s">
                        <div class="cs_our_service_icon">
                            <img src="{{ asset('images/backend') }}/{{ $item->icon }}" class="img-fluid" alt="images">
                        </div>
                    ...
                    <div class="cs_blog_section" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 0.8s; animation-name: slideInLeft;">
                        <div class="cs_blog_img_box">
                            <div class="cs_blog_img">
                                <img src="{{ asset('images/backend') }}/{{ $product->image }}" class="img-fluid" alt="images">
